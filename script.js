document.addEventListener('DOMContentLoaded', () => {
    ...
    // Smooth Scroll for Navigation (Optional enhancement for older browsers or specific offsets)
    ...
    // Dynamic Title Update (Simple interactive touch)
    const title = document.title;
    window.addEventListener('blur', () => {
        document.title = 'Come back soon! | ' + title;
    });
